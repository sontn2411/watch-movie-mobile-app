...
import { Svg, Path, Circle, Line, Polyline, SvgProps as RNSvgProps } from 'react-native-svg';
...
const ICON_LIST = {
  home: (props: SvgProps) => (
    <Svg viewBox="0 0 24 24" fill="none" stroke={props.color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
